...
- [ ] T047 [US2] Add the issue page's skeleton — main column and rail shapes — to `src/features/issues/components/issue-skeletons.tsx`, matching the layout it replaces closely enough that nothing already on the page moves when the data lands, and never a full-screen spinner (FR-067, SC-021, `OT-UX-005`) — depends on T027, which creates the file
